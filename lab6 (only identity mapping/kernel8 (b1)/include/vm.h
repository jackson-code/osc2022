...
/*
// address of PGD's page frame (buddy sys should reserve?)
#define PGD_VIRT_ADDR   (pg_addr)
#define KERNEL_VIRT     (0xffff << 48)
#define PGD_ADDR        ((PGD_VIRT_ADDR & (~KERNEL_VIRT)))
#define PUD_ADDR        (PGD_VIRT_ADDR + 0x1000)
*/
