...
*/
// bit[1:0]
#define PD_TABLE        (0b11UL)
#define PD_BLOCK        (0b01UL)
#define PD_PAGE         (0b11UL)
// bit[7:6]
#define PD_PERM_RW              (0b0 << 7)
#define PD_PERM_R               (0b1 << 7)
#define PD_PERM_KER_USER        (0b1 << 6)  // kernel/user access
#define PD_PERM_KER             (0b0 << 6)  // only kernel access
// bit[10]
